...
// API fetch helper with required Bunny CDN options, what it does it wrap the url that i have provided with the requried headers and body 
export const apiFetch = async <T = Record<string, unknown>>(
  ...
  // take whatever the user has provided in the headers using ...headers , basically here we are populating the header with the 
  // required field to make a request to bunny
